...
public class GlobalExceptionHandler {
    ...
    private HttpStatus statusFor(ErrorCode errorCode) {
        return switch (errorCode) {
            ...
            case CONFLICT, EMAIL_ALREADY_EXISTS, TOKEN_ALREADY_USED, PROFILE_VERSION_CONFLICT -> HttpStatus.CONFLICT;
            case INVALID_TOKEN, TOKEN_EXPIRED, ASSESSMENT_EXPIRED, BACKUP_VERSION_UNSUPPORTED -> HttpStatus.BAD_REQUEST;
